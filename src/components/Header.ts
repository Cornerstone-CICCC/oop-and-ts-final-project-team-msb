...
export class Header {
  ...
  constructor(allTasks: TaskContext[], onTaskClick: (task: TaskContext) => void) {
  ...
  render(): HTMLElement {
    ...
    const input = header.querySelector(".search-input") as HTMLInputElement;
    const results = header.querySelector(".search-results") as HTMLUListElement;
